...
<body>
	...
	<div class="wrap">
		...
		<section class="section fadeInUp">
			<h2 class="title-02" id="skill">고객등록화면</h2>
<!--			<h3 class="title-03">프로그램 작성순서</h3>-->
			<form action="/save" class="mt-50" id="form" method="POST">
				<div class="ly-flex">
					<h6 class="mr-20 wp-150 bold">고객번호</h6>
					<input type="text" name="cust_no" id="cust_no" readonly value="${nextCustNo}">
				</div>
				...
				<div class="ly-flex-center mt-45 t-center">
					...
					<button type="button" class="ml-20" onclick="goBack()">취소</button>
				</div>
	...
	<script>
		function onSubmit() {
			...
			document.querySelector('#join_date').value = formattedDate;
