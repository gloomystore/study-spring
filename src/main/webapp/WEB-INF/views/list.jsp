...
<body>
	...
	<div class="wrap">
		...
		<section class="section fadeInUp">
				<h2 class="title-02" id="skill">고객대여리스트</h2>
				...
				<div class="table mt-50">
                    ...
                    <tbody>
                        <c:forEach var="rentInfo" items="${rentList}">
                            <tr>
                                <td>
                                    <p class="td-desc">${rentInfo.cust_no}</p>
                                </td>
                                <td>
                                    <p class="td-desc">${rentInfo.rent_no}</p>
                                </td>
                                <td>
                                    <p class="td-desc">${rentInfo.book_code}</p>
                                </td>
                                <td>
                                    <p class="td-desc">${rentInfo.rent_price}</p>
                                </td>
                                <td>
                                    <p class="td-desc">${rentInfo.rent_date}</p>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
